<?php
	...
	mail($conference_admin['email'], "Confirmation for Innovation Bootcamp", print_r($_POST, true), $headers);
	mail($_POST['email'], "Confirmation for Innovation Bootcamp", "Thank you for making a payment for the mycompany Innovation Bootcamp. If we have any questions we will contact you shortly.", $headers);
?>
