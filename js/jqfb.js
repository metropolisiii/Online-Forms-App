	...
	$.fn.serializeFormList = function (options) {
		...
		this.each(function () {
			...
			if (payment){
				...
				li_count++;
				serialStr+='&frmb['+li_count+'][cssClass]=auth_code&frmb['+li_count+'][required]=undefined&frmb['+li_count+'][readonly]=undefined&frmb['+li_count+'][validate_date]=undefined&frmb['+li_count+'][word_count]=undefined&frmb['+li_count+'][defaultvalue]=undefined&frmb['+li_count+'][use_for_confirmation]=undefined&frmb['+li_count+'][character_count]=undefined&frmb['+li_count+'][values]=Auth_Code';
				li_count++;
