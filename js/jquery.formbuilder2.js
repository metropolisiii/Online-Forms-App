	...
	$.fn.formbuilder = function (options) {
		...
		return this.each(function () {
			...
			var controlBox = function (target) {
					...
					box_content = '<div  class="frmb-control" style="position:fixed"> <div id="form_box_tools"><img src="images/pencil.png"/><span>Form Box Tools</span></div>'
			...
			var appendDiscountField = function(values, discount_code, discount_amount,  discount_multiplier){
				...
				field += '<div class="frm-fld"><label for="discount_amount-'+last_id+'">' + opts.messages.discount_amount + '</label><span style="float:left; font-size:24px; margin-top:7px;"></span><input class="discount_amount" size="5" value="'+discount_amount+'" style="float:none;" type="text" name="discount_amount-'+last_id+'" id="discount_amount-'+last_id+'" /></div>';
	...
	$.fn.serializeFormList = function (options) {
		...
		this.each(function () {
			...
			if (payment){
				...
				li_count++;
				serialStr+='&frmb['+li_count+'][cssClass]=date_paid&frmb['+li_count+'][required]=undefined&frmb['+li_count+'][readonly]=undefined&frmb['+li_count+'][validate_date]=undefined&frmb['+li_count+'][word_count]=undefined&frmb['+li_count+'][defaultvalue]=undefined&frmb['+li_count+'][use_for_confirmation]=undefined&frmb['+li_count+'][character_count]=undefined&frmb['+li_count+'][values]=Date_Paid';	
				li_count++;
				serialStr+='&frmb['+li_count+'][cssClass]=amount_paid&frmb['+li_count+'][required]=undefined&frmb['+li_count+'][readonly]=undefined&frmb['+li_count+'][validate_date]=undefined&frmb['+li_count+'][word_count]=undefined&frmb['+li_count+'][defaultvalue]=undefined&frmb['+li_count+'][use_for_confirmation]=undefined&frmb['+li_count+'][character_count]=undefined&frmb['+li_count+'][values]=Amount_Paid';			
				li_count++;
				serialStr+='&frmb['+li_count+'][cssClass]=cc_number&frmb['+li_count+'][required]=undefined&frmb['+li_count+'][readonly]=undefined&frmb['+li_count+'][validate_date]=undefined&frmb['+li_count+'][word_count]=undefined&frmb['+li_count+'][defaultvalue]=undefined&frmb['+li_count+'][use_for_confirmation]=undefined&frmb['+li_count+'][character_count]=undefined&frmb['+li_count+'][values]=CC_Number';
