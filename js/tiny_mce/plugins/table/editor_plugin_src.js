		...
		init : function(ed, url) {
			...
			ed.onInit.add(function(ed) {
				...
				function tableCellSelected(ed, rng, n, currentCell) {
					...
					// required is actually a pointer to the user cause of this bug. A cell is selected when the start 
				...
				// This fix will force a paragraph element after the table but only when the forced_user_block setting is enabled
				function fixTableCaretPos() {
					...
					if (last && last.nodeName == 'TABLE') {
						if (ed.settings.forced_user_block)
							ed.dom.add(ed.getBody(), ed.settings.forced_user_block, null, tinymce.isIE ? '&nbsp;' : '<br data-mce-bogus="1" />');
						else
