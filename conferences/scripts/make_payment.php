...
<input type='hidden' name="conf_user" value="<?php echo $_POST['conf_user']; ?>">
...
<INPUT TYPE='hidden' NAME="x_trans_id" VALUE="234">
<INPUT TYPE='hidden' NAME="x_account_number" VALUE="12345">
<INPUT TYPE='hidden' NAME="x_first_name" VALUE="Jason">
<INPUT TYPE='hidden' NAME="x_last_name" VALUE="Kirby">
...
<INPUT TYPE='HIDDEN' NAME="billcode" VALUE="WC2016VENDOR"/>
